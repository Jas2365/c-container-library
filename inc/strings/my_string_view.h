...
[[nodiscard]] string_view  String_View   (string str);
[[nodiscard]] string_view  nString_View  (string str, s64 n);
[[nodiscard]] string_vw    String_vw     (string str);
[[nodiscard]] string_vw    nString_vw    (string str, s64 n);
...
[[nodiscard]] string_vw    String_vw_literal     (string_literal str);
[[nodiscard]] string_vw    nString_vw_literal    (string_literal str, s64 n);
